...
gL_file <- file.path(ddir, subid, paste(subid, "_allruns_333_zmdt_resid_mntrpl_bpss_zmdt_tmasked_smooth2.55mm_L_32k_fsLR.func.gii", sep=""))
gR_file <- file.path(ddir, subid, paste(subid, "_allruns_333_zmdt_resid_mntrpl_bpss_zmdt_tmasked_smooth2.55mm_R_32k_fsLR.func.gii", sep=""))

nodeL_file <- file.path("../Chan_RSFC_Nodes/gifti_multiple_columns/ROI_L_dis8_fwhm0_limit3_overlapEXCLUDE.func.gii")
nodeR_file <- file.path("../Chan_RSFC_Nodes/gifti_multiple_columns/ROI_R_dis8_fwhm0_limit3_overlapEXCLUDE.func.gii")
